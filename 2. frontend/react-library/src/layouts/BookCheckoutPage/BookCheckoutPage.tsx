...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBook = async () => {
            const url: string = `${process.env.REACT_APP_API}/data/books/${bookId}`;
    ...
    useEffect(() => {
        const fetchBookReviews = async () => {
            const reviewUrl: string = `${process.env.REACT_APP_API}/data/reviews/search/findByBookId?bookId=${bookId}`;
            ...
            if (loadedReviews) {
                setTotalStars(weightedStarReviews / loadedReviews.length);
            }
